...
// perform the activation methods, which don't get run above
do_action( 'activate_church-theme-content/church-theme-content.php' );
do_action( 'activate_church-theme-content-integration/church-theme-content-integration.php' );
