...
It adds the ability to synchronise data from other church-related service providers into Church Theme Content custom
post types with the click of a button, rather than maintaining such information in multiple places.
...
will still install without CTC, but you wont be able to run anything.
- The PHP cURL library to communicate with Fellowship One. This plugin, once activated, will check that it exists and
...
1. Get your [API key](http://developer.fellowshipone.com/key/). Select the People, Groups, and Events realms. Currently
only the People and Group realms are required, but support for Events may be added later.
