...
class CTCIPersonTest extends PHPUnit_Framework_TestCase {
	...
	public static function getNameData() {
		return array(
			...
			array(
				array( 'Mr', '', 'Christopher', 'Chris', 'Garry', 'Burgess', '' ), 'L, F M',
				'Burgess, Christopher Garry'
			),
			array(
				array( 'Mr', '', 'Christopher', 'Chris', 'Garry', 'Burgess', 'Ph.D' ), 'T. F M L S',
				'Mr. Christopher Garry Burgess Ph.D'
			),
			array(
				array( 'Mr', 'Pfx', 'Christopher', 'Chris', 'Garry', 'Burgess', 'Ph.D' ), 'P F M L S',
				'Pfx Christopher Garry Burgess Ph.D'
			),
			array(
				array( 'Mr', 'Pfx', 'Christopher', 'Chris', 'Garry', 'Burgess', 'Ph.D' ), 'T. F J L S',
				'Mr. Christopher G Burgess Ph.D'
			),
			array(
				array( 'Mr', 'Pfx', 'Christopher', 'Chris', 'Garry', 'Burgess', 'Ph.D' ), 'T. I. J. K. S',
				'Mr. C. G. B. Ph.D'
			),
			array(
			...
			array(
				array( 'Mr', 'Pfx', 'Christopher', 'Chris', 'Garry', 'Burgess', 'Ph.D' ), 'FQ L',
				'Christopher "Chris" Burgess'
			),
			array(
